        ...
        <form onSubmit={handleSubmit} className="w-full">
          <div className="mb-6">
            ...
            <Input
              ...
              required
              className="bg-[#E6F0FA] text-black border border-green-100 focus:border-[#0058A3] focus:ring-0"
            />
          </div>
          <div className="mb-6">
          ...
          <div className="mt-6 text-center">
            <Link
              href="/lost-pass"
              className="text-black hover:text-[#0058A3] font-medium transition-colors"
            >
              Forgot password?
            </Link>
            <div>
              <Link href="/register" className="text-black hover:text-[#0058A3] font-medium transition-colors">
